                ...
                <div className="grid grid-cols-5 gap-8 max-w-[1280px] mx-auto text-white text-sm">
                  ...
                  <div className="flex flex-col space-y-3">
                    <div className="font-semibold text-base mb-2">
                      <a href="/products/crushes" className="hover:text-black transition-colors">Crushers</a>
                    </div>
                    <a href="#" className="hover:text-black transition-colors">Jaw Crushers</a>
                    <a href="#" className="hover:text-black transition-colors">Cone Crushers</a>
                    <a href="#" className="hover:text-black transition-colors">Roll Crushers</a>
                  </div>
                  {/* Column 2: Mobile Series */}
                  <div className="flex flex-col space-y-3">
                    <div className="font-semibold text-base mb-2">
                      <a href="#" className="hover:text-black transition-colors">Mobile Series</a>
                    </div>
                    <a href="#" className="hover:text-black transition-colors">Track Mounted Jaw Crusher</a>
                    <a href="#" className="hover:text-black transition-colors">Track Mounted Cone Crusher</a>
                    <a href="#" className="hover:text-black transition-colors">Track Mounted Endurer</a>
                    <a href="#" className="hover:text-black transition-colors">Track Mounted Vertical Shift Impactor</a>
                    <a href="#" className="hover:text-black transition-colors">Track Mounted Screen</a>
                    <a href="#" className="hover:text-black transition-colors">Track Mounted Scalper</a>
                  </div>
                  {/* Column 3: Semi Mobile Series */}
                  <div className="flex flex-col space-y-3">
                    <div className="font-semibold text-base mb-2">
                      <a href="/products/semi-mobile-series" className="hover:text-black transition-colors">Semi Mobile Series</a>
                    </div>
                    <a href="#" className="hover:text-black transition-colors">Pro Fast Jaw</a>
                    <a href="#" className="hover:text-black transition-colors">Pro Fast Cone</a>
                    <a href="#" className="hover:text-black transition-colors">Pro Fast Vertical Shift Impactor</a>
                  </div>
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <a href="/products/feeders/feeder-screen" className="hover:text-black transition-colors">Feeder Screen</a>
                    <a href="/products/feeders/pan-feeder" className="hover:text-black transition-colors">Pan Feeder</a>
                    ...
                    <a href="/products/impactors/vsi" className="hover:text-black transition-colors">Vertical Shift Impactor</a>
                    <a href="/products/impactors/hsi" className="hover:text-black transition-colors">Horizontal Shift Impactor</a>
                  </div>
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <a href="/products/screens/vibrating" className="hover:text-black transition-colors">Vibrating Screen</a>
                    <div className="font-semibold text-base mt-4 mb-2">
                      <a href="/products/washing-systems" className="hover:text-black transition-colors">Washing Systems</a>
                    </div>
                    <a href="/products/washing-systems/sand-washer" className="hover:text-black transition-colors">Sand Washer</a>
                    <a href="/products/washing-systems/dual-sand-washer" className="hover:text-black transition-colors">Dual Sand Washer</a>
                    <div className="font-semibold text-base mt-4 mb-2">
                      <a href="/products/classifier" className="hover:text-black transition-colors">Classifier</a>
                    </div>
                    <a href="#" className="hover:text-black transition-colors">Pro Air Classifier</a>
                  </div>
                  <div className="font-semibold text-base mb-2">
                    <a href="/products/screens" className="hover:text-black transition-colors">Concerete Batching Solution </a>
                  </div>
                  <div className="font-semibold text-base mb-2">
                    <a href="/products/screens" className="hover:text-black transition-colors">Mechanical Road Paver </a>
                  </div>
                  <div className="font-semibold text-base mb-2">
                    <a href="/products/screens" className="hover:text-black transition-colors">EV -  Dumper Truck </a>
                  </div>
                  <div className="font-semibold text-base mb-2">
                    <a href="/products/screens" className="hover:text-black transition-colors">EV- Tractor Trailer Truck </a>
                  </div>
                </div>
              </div>
            )}
