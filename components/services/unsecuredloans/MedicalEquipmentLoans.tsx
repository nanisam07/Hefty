    ...
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <div className="rounded-xl overflow-hidden shadow-md">
              <Image
                src="/unstructured/M2.jpg" // make sure to place the image in /public folder
                alt="Team"
                width={700}
                height={400}
          ...
          <section className="bg-[#132b4a] text-white px-8 py-16">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-700 p-6">
                  <h3 className="text-2xl font-semibold mb-2">Quick Approvals & Disbursal in 48–72 Hours</h3>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="w-full rounded-xl overflow-hidden shadow-md">
          <Image
            src="/unstructured/M3.jpg" // Place this in /public
...
"Minimum 1–2 years of practice or business continuity",
